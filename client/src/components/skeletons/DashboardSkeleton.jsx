...
export default function DashboardSkeleton() {
  return (
    <div className="space-y-6" aria-hidden="true">
      ...
      <div className="bg-[var(--sv-surface)] border border-[var(--sv-border)] rounded-2xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="bg-[var(--sv-surface)] border border-[var(--sv-border)] rounded-2xl p-5 space-y-4">
        ...
        <div className="lg:col-span-2 grid grid-cols-2 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-[var(--sv-surface)] border border-[var(--sv-border)] p-5 rounded-2xl space-y-3">
              <div className="flex justify-between items-center">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="bg-[var(--sv-surface)] border border-[var(--sv-border)] rounded-xl p-3.5 space-y-2 text-center">
