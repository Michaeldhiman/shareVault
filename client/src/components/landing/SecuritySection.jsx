...
const LAYERS = [
  ...
  },
  {
    ...
    description: '600,000 iterations transform your password into a cryptographic key using salted SHA-256.',
    tag: '600K Iterations',
  },
  {
    level: '03',
    ...
    description: 'Your vault data is encrypted client-side with military-grade AES-256 before any sync.',
    tag: 'Zero-Knowledge',
  },
  {
    level: '04',
...
export default function SecuritySection() {
  return (
    ...
    >
      {/* Ambient glow */}
      <div
        className="absolute top-1/3 right-0 w-[500px] h-[500px] opacity-[0.04] pointer-events-none"
      ...
      <div className="container-xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              Military-grade.<br />
              <span className="italic text-white/40">Human-friendly.</span>
            </motion.h2>
            ...
            <motion.p
              ...
              className="font-display text-lg text-white/60 leading-relaxed mb-10"
            >
              End-to-end encryption. Zero-knowledge architecture.
              We built SecureVault so that even if our servers were breached tomorrow,
              your data would remain completely unreadable.
            </motion.p>
            ...
            >
              {GUARANTEES.map((item, i) => (
                <motion.li
                  ...
                  className="flex items-start gap-3 text-sm font-display text-white/70"
                >
                  <CheckCircle2 size={15} className="text-emerald-400 flex-shrink-0 mt-0.5" strokeWidth={2.5} aria-hidden="true" />
                  {item}
                </motion.li>
              ))}
            </motion.ul>
            ...
            {LAYERS.map((layer, i) => {
              ...
              return (
                ...
                >
                  {/* Level number */}
                  <span
                    className="font-mono text-xs font-bold flex-shrink-0 w-7"
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-0.5">
                      <p className="font-display text-sm font-semibold text-white/85">{layer.title}</p>
                      <span
                        className="text-[10px] font-display font-bold tracking-wider px-2 py-0.5 rounded-full flex-shrink-0"
                        style={{
                          background: `${layer.color}10`,
                          color: layer.color,
                    ...
                    <p className="text-xs font-display leading-snug" style={{ color: `${layer.color}e0` }}>{layer.description}</p>
                  </div>
            ...
            >
              ...
              >
                ...
                <span className="font-mono text-xs text-emerald-400 font-semibold tracking-wide">
                  {"{ encrypted: true, readable_by_us: false }"}
                </span>
              </div>
            </motion.div>
          </div>
