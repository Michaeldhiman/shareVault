      ...
      <div className="space-y-8 pb-12">
        ...
        <div className="border-b border-[#242433] pb-5">
          ...
          <p className="text-xs text-slate-400 mt-0.5">
            Identify compromised credentials, reuse groups, and weak encryption structures locally.
          </p>
        </div>

        {/* Hero Score Console */}
        <div className="bg-[#151521]/60 border border-[#242433] rounded-2xl p-6 shadow-xl relative overflow-hidden backdrop-blur-md">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
            <div className="flex-1 space-y-4 text-center md:text-left">
              <div>
                ...
                <h2 className="text-xl font-extrabold text-white tracking-tight mt-1 font-heading">
                  {stats.healthScore >= 80 ? 'Vault Rating: Optimal' : stats.healthScore >= 50 ? 'Vault Rating: Action Needed' : 'Vault Rating: Critical Warning'}
                </h2>
                <p className="text-xs text-slate-400 mt-2 max-w-lg leading-relaxed">
                  Your Master Password derives local AES keys. We audit password entropy and database leaks without sending plaintext data to the cloud.
                </p>
              </div>
            ...
            <div className="flex items-center gap-6 shrink-0 bg-slate-950/40 border border-[#242433]/60 p-4.5 rounded-2xl shadow-inner">
              ...
              <div className="space-y-1">
                <div className="text-[9px] uppercase tracking-wider text-slate-500 font-mono font-bold">Health</div>
                <span
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#151521]/60 border border-[#242433] rounded-2xl p-5 shadow-xl backdrop-blur-md">
                    ...
                    <ul className="space-y-2">
                      {weakItems.map((item, idx) => {
                        ...
                        return (
                          <li
                            key={item.id}
                            className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 bg-slate-950/60 border border-[#242433] rounded-xl"
                          >
                            <div className="flex items-center gap-3 min-w-0">
                              ...
                              <div className="min-w-0">
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                  <span className="text-[9px] text-rose-400 bg-rose-500/10 border border-rose-500/20 px-1.5 py-0.5 rounded-md font-mono">
                                    Score: {score}/4
                                  </span>
                                  <span className="text-[10px] text-slate-400">Weak entropy password</span>
                                </div>
                              </div>
                            </div>
                            ...
                            <button
                              ...
                              className="text-blue-400 hover:text-blue-300 p-2 rounded-lg bg-blue-500/5 hover:bg-blue-500/15 border border-blue-500/10 transition-colors shrink-0 align-self-end sm:align-self-center"
            ...
            {weakItems.length === 0 && (
              <div className="mt-5 flex flex-col items-center justify-center py-6 rounded-xl bg-emerald-500/5 border border-emerald-500/10 text-center">
                ...
                <p className="text-xs text-slate-400 mt-1 max-w-xs px-4">
                  No weak passwords found. Every credential meets complexity score recommendations.
                </p>
              </div>
            )}
          </div>
